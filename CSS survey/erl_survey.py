...
def results():
    ...
    with tab2:
        ...
        if persona == 'Architect':
            ...
            text = '''Your company brings a compelling strategic vision, grounded in deep market knowledge and technological insight. 
            ...
            st.markdown(f'<div class="results-card">{text}</div>', unsafe_allow_html=True)
        elif persona == 'Engineer':
            st.markdown(f"""<div class="persona-inline"><p class="persona-label">Based on your innovation profile, you are an</p><span class="persona-badge">{persona}</span></div>""", unsafe_allow_html=True)
            text ='''You excel at turning ideas into reality through strong internal systems and a structured approach to innovation. 
            ...
            text = '''Your company reflects a rare balance of expertise, openness, and operational maturity. 
        ...
        if persona == 'Campaigner':
            st.markdown(f"""<div class="persona-inline"><p class="persona-label">Based on your innovation profile, you are a</p><span class="persona-badge">{persona}</span></div>""", unsafe_allow_html=True)
            text = '''Your company demonstrates a strong commitment to innovation through leadership that inspires and motivates others. 
            ...
            st.markdown(f"""<div class="persona-inline"><p class="persona-label">Based on your innovation profile, you are a</p><span class="persona-badge">{persona}</span></div>""", unsafe_allow_html=True)
            text ='''Your company is highly adaptable, with leadership that is open to innovation and a focus on continuous improvement. 
            ...
            st.markdown(f"""<div class="persona-inline"><p class="persona-label">Based on your innovation profile, you are a</p><span class="persona-badge">{persona}</span></div>""", unsafe_allow_html=True)
            text ='''Your company has a strong culture of collaboration and values innovation. 
        ...
        if persona == 'Driver':
            st.markdown(f"""<div class="persona-inline"><p class="persona-label">Based on your innovation profile, you are a</p><span class="persona-badge">{persona}</span></div>""", unsafe_allow_html=True)
            text = '''You have built a strong foundation of processes that allow you to move quickly from idea to action. Your strength lies in execution—getting things done efficiently and at scale. 
            ...
            st.markdown(f"""<div class="persona-inline"><p class="persona-label">Based on your innovation profile, you are an</p><span class="persona-badge">{persona}</span></div>""", unsafe_allow_html=True)
            text = '''Your company has clearly established operational capabilities and leadership support that enable consistent and scalable innovation. 
            ...
            st.markdown(f"""<div class="persona-inline"><p class="persona-label">Based on your innovation profile, you are an</p><span class="persona-badge">{persona}</span></div>""", unsafe_allow_html=True)
            text ='''You are in a strong position to translate innovative ideas into action, thanks to your balance of collaborative leadership and agile operations. 
